...
exports.writeToFile = co.wrap(function*(languageCodeMap){
    ...
    try{
        ...
        promises.push(write(path.resolve(process.cwd(),formatId(languageCodeMap._id)+'.'+languageCodeMap._title,languageCodeMap._title+'.title.md'),languageCodeMap['_question']))
        yield promises;
    }catch(err){
